...
async function connectToWA() {
  console.log("Connecting NAWIDU-MAXbot 🧬...");
  ...
  danuwa.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log('✅ NAWIDU-MAXbot connected to WhatsApp');

      const up = `NAWIDU-MAXbot connected ✅\n\nPREFIX: ${prefix}`;
      await danuwa.sendMessage(ownerNumber[0] + "@s.whatsapp.net", {
        image: { url: `https://tpc.googlesyndication.com/pimgad/282398783129411033` },
        caption: up
      });
